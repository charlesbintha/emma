...
@section('title', 'Ajouter un Parfum')

@section('content')
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h3>Ajouter un Parfum</h3>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Formulaire d'ajout de parfum</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('perfumes.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           ...
                                           placeholder="Ex: Chanel N°5" required>
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('brand') is-invalid @enderror"
                                           ...
                                           placeholder="Ex: Chanel" required>
                                    @error('brand')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              ...
                                              placeholder="Description du parfum...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="image_url">Image du parfum</label>
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary">
                                    <i data-feather="save"></i> Enregistrer le parfum
                                </button>
